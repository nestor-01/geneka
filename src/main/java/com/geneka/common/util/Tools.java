...
public class Tools
{
     ...
     *
     * @param mapContext Context map
     * @return JSon String
     */
    public static String serializeContextToJSon(Map<String, Object> mapContext) throws IOException
    {
        return null != mapContext && !mapContext.isEmpty()
               ? serializeToJSon(mapContext)
               : "";
    }
     ...
     *
     * @throws IOException If an error happens during serialization
     */
    ...
    public static <T> T deserializeFromJSon(String json, Class<T> clazz) throws IOException
    {
    ...
    public static <T> String serializeDefaultTypingToJSon(T object) throws IOException
    {
    ...
    public static <T> T deserializeDefaultTypingFromJSon(String json, Class<T> clazz) throws IOException
    {
        long s = System.currentTimeMillis();
        if (json == null || json.trim().isEmpty())
        {
    ...
    public static boolean isValidBooleanString(String status)
    {
        return !status.equals("") &&
               (Boolean.parseBoolean(status) || status.equals(Boolean.FALSE.toString()));
    }
